...
TUTORIAL_2D_RENDERER = "academic_2d_panel_stitch"
...
TUTORIAL_2D_CLAIM_BOUNDARY = (
    "Supplement 2D visual panels explain the scoped diagnostic path; "
...
def write_supplement_ai_tutorial_sidecars(
    *,
    ...
    if unknown:
        raise ValueError(f"unknown supplement visual slot id: {', '.join(unknown)}")
    outputs: list[Path] = []
...
def _write_sidecar(spec: TutorialSlotSpec, slot_path: Path) -> Path:
    ...
    payload = {
        ...
        "recipe": "labeled_panel_strip_selected_by_visual_review",
        "source_id": spec.source_id,
        "prompt_summary": spec.prompt_summary,
        "slot_asset": _portable_path(slot_path),
        "slot_sha256": _sha256_file(slot_path),
        "slot_composition": {
            "layout": "wide panel strip; paper composer splits semantic segments and contains each segment",
            "segment_bounds_x": list(spec.segment_bounds_x),
        },
        "panel_count": spec.panel_count,
        "panels": [
            {"index": index + 1, "role": "labeled academic panel"}
...
def _slot_specs() -> dict[str, TutorialSlotSpec]:
    return {
        "supplement_candidate_lane_anatomy": TutorialSlotSpec(
            ...
            prompt_summary=(
                "Labeled academic panel strip: generator lanes, package "
                "manifest, and diagnostic check outcomes."
            ),
            source_id="visual_slot:ig_0c846f8ef4c4d1bf016a213b14858c819780eedb0d8d4b7430",
        ...
        "supplement_generated_package_consumption": TutorialSlotSpec(
            ...
            prompt_summary=(
                "Labeled academic robotics panel strip: source inventory, "
                "generated package replacement, and body/filter/pair counts."
            ),
            source_id="visual_slot:ig_0c846f8ef4c4d1bf016a213c073d0c8197a26fa77bd0686718",
        ...
        "supplement_compound_body_state_teaching": TutorialSlotSpec(
            ...
            prompt_summary=(
                "Labeled academic panel strip: primitive parts, aggregate "
                "body COM/inertia, and diagnostic gate consequence."
            ),
            source_id="visual_slot:ig_0c846f8ef4c4d1bf016a213b5a14788197a8fa6c7e9b842a5d",
        ...
        "supplement_franka_link_frames": TutorialSlotSpec(
            ...
            prompt_summary=(
                "Labeled academic robotics panel strip: link labels, "
                "owner/frame attachment labels, and cross-link merge-risk label."
            ),
            source_id="visual_slot:ig_0c846f8ef4c4d1bf016a213bbed3a08197817a8c5772f23057",
        ...
        "supplement_franka_source_suppression": TutorialSlotSpec(
            ...
            prompt_summary=(
                "Labeled academic panel strip: before source shapes, source "
                "shape replacement, and generated-count audit."
            ),
            source_id="visual_slot:ig_0c846f8ef4c4d1bf016a213c5898788197b5d77a34a2c23c4b",
            source_records=("docs/records/2026-05-26-generated-package-robot-task-probe.md",),
        ),
        "supplement_provenance_flow": TutorialSlotSpec(
            ...
            prompt_summary=(
                "Labeled academic panel strip: config inputs, evidence records, "
                "manifest hashes, and supplement PDF audit output."
            ),
            source_id="visual_slot:ig_0c846f8ef4c4d1bf016a213c9d8c1c8197b7c133e451163d8f",
