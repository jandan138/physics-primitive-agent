...
- Current local build: `make -C paper accv` produces `paper/venues/accv/build/main.pdf` with 13 main-content pages plus three reference-only pages after the Fig. 1 visual pass, reference expansion, main-PDF appendix removal, and main-text float compaction.
