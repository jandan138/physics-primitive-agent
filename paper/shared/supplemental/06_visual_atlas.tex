...
atlas adds explanatory plates and diagrams for reviewers who want to inspect the diagnostic
logic visually. The plates cover predicate anatomy, failure storyboards, package accounting,
robot-link ownership, and provenance flow. These figures are distinct from the main-paper figures
and do not add new runtime evidence.
...
\caption{Bowl failure storyboard. The storyboard format separates the simulated
...
\caption{Cup and tray failure storyboards. Two assets are shown with the same
