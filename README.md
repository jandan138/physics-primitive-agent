...
fixture-breadth Batch A source/preprocess, Batch B primitive-fit, Batch C cost/search/stop, and
Batch D component-pair accounting, advancing the next paper-lane gate to Batch E postprocess
breadth while keeping the report partial and offline-only. See
