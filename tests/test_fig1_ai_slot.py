...
def test_compose_fig1_ai_slot_uses_manifest_slots_and_writes_pdf(tmp_path: Path) -> None:
        ...
        yaml.safe_dump(
            {
                ...
                "mode": "hybrid_newton_visual_composition",
                ...
                "slot_sources": {
                    ...
                    "decision_report": {"renderer": "visual_panel_composition"},
                },
    ...
    assert composed.evidence == "Hybrid Newton protocol schematic; exposition only"
    assert composed.renderer_metadata["mode"] == "hybrid_newton_visual_composition"
    ...
    assert composed.renderer_metadata["slot_sources"]["decision_report"]["renderer"] == "visual_panel_composition"
...
def test_fig1_ai_slot_manifest_is_replaceable_and_claim_bounded() -> None:
    ...
    assert manifest["mode"] == "hybrid_newton_visual_composition"
    ...
    assert slot_sources["decision_report"]["renderer"] == "visual_panel_composition"
...
def test_fig1_ai_slot_is_integrated_into_accv_sources() -> None:
    ...
    assert "hybrid_newton_visual_composition" in sources
    assert "fig1_franka_rtx_slots" in sources
