...
- Current run scope: the follow-up run covers bounding-primitive, CPD-style, CoACD convex-mesh,
  ...
  Franka link-aware package generation and boundary audit with all detected links covered, zero
  cross-link merges, and `/panda/panda_link8` recorded as a meshless placeholder.
