...
- polygon/quad intake policy or an explicit documented restriction for the declared fixture scope;
...
1. Define `paper_polygon_quad_intake_policy_audit` for triangle, quad, and higher-arity polygon
   inputs.
2. Record source-face remap behavior and normal/tangent operator ownership for non-triangle input.
