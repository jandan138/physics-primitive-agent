...
1. Implement `paper_mapped_subset_newton_shape_runtime_engine_builder_runtime_execution_contract`
   only after the bounded skipped-smoke row exists.
2. Keep the constructed runtime `PrimitiveSpec` object, preflight candidate, generated
   ...
   environment-probe/API-surface records, engine-builder entry record, and skipped-smoke record
