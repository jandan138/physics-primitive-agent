...
1. Implement `paper_package_conversion_mapped_subset_plan` as the next paper-lane planning gate
   before any package generation.
2. Define how only explicitly Newton-mapped paper-lane rows may later enter package conversion,
