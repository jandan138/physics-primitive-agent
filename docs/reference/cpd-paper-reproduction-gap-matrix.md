...
Batch A of the fixture-breadth expansion is now implemented inside the offline report. The next
implementation slice should remain offline only:

1. Implement `paper_fixture_breadth_batch_b` from the fixture-breadth plan.
2. Add only the primitive-fit breadth fixtures planned for Batch B.
