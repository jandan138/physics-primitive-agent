...
at zero. The next implementation slice should
...
1. Implement `paper_mapped_subset_newton_shape_runtime_engine_builder_boundary_preflight_contract`
   after the bounded recording-builder construction artifact exists.
2. Keep the constructed runtime `PrimitiveSpec` object, preflight candidate, generated
   ...
   builder-preflight call-plan and recording-builder call records
