...
- paper-faithful OBB and sphere fitting behavior or explicit documented surrogate boundary for the
  declared fixture scope;
...
2. Record whether those rows use paper-faithful parameter construction or keep explicit surrogate
   labels.
