...
1. Add enclosed-primitive postprocess audit for a named toy fixture.
2. Record primitive counts before and after culling, enclosed primitive ids, enclosing primitive ids,
   containment test type, and cull reasons.
