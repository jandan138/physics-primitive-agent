...
Batch A, Batch B, Batch C, and Batch D of the fixture-breadth expansion are now implemented inside the
offline report.
The next implementation slice should remain offline only:

1. Implement `paper_fixture_breadth_batch_e` from the fixture-breadth plan.
2. Add only the postprocess breadth fixtures planned for Batch E.
