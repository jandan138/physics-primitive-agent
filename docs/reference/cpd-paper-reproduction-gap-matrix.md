...
1. Implement
   ...
   only after the bounded configured-runtime smoke row exists.
2. Keep the constructed runtime `PrimitiveSpec` object, preflight candidate, generated
   ...
   configured-runtime preflight/validation/source-resolution/device-resolution/entry-decision/smoke
