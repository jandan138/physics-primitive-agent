...
Batch A, Batch B, and Batch C of the fixture-breadth expansion are now implemented inside the
offline report.
The next implementation slice should remain offline only:

1. Implement `paper_fixture_breadth_batch_d` from the fixture-breadth plan.
2. Add only the component-pair breadth fixtures planned for Batch D.
