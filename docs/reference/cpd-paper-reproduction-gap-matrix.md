...
1. Add component-pair edge insertion inside the offline priority-queue trace.
2. Record disconnected component-pair candidates, minimum-cost pops, accepted/blocked merges,
   threshold policy, updated neighbor candidates, target-count or threshold stop reason, and the
