...
decision while keeping runtime-execution attempts and Newton execution at zero. The next
implementation slice
should keep the same boundary discipline:

1. Implement `paper_mapped_subset_newton_shape_runtime_engine_builder_runtime_lane_review_contract`
   only after the bounded skipped-runtime-execution row exists.
