...
- The current executable surface can run the command-only CPD paper offline generalization-plan
  ...
  report-only skipped-runtime-execution, and report-only runtime-lane review contracts.
  The
...
- The current executable surface can also run
  ...
  environment-probe, API-surface, entry, smoke, runtime-execution, and runtime-lane review slices below now advance the
...
- The current executable surface can also run
  ...
  API-surface, entry, smoke, runtime-execution, and runtime-lane review slices below advance the current next gate to
  `paper_mapped_subset_newton_shape_runtime_engine_builder_configured_runtime_design_contract`.
  This is not
...
- The current executable surface can also run
  ...
  of runtime-compatibility wording, and advances the current next gate to
  `paper_mapped_subset_newton_shape_runtime_engine_builder_configured_runtime_design_contract`.
